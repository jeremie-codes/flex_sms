                    ...
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6">
                            ...
                            <div class="mt-1 flex rounded-md shadow-sm">
                                <input type="text" name="code" id="code" value="{{ old('code', $configuration->code) }}" required class="focus:ring-blue-500 focus:border-blue-500 flex-1 block w-full rounded-none rounded-l-md sm:text-sm border-gray-300">
                ...
                <div class="mt-5 md:mt-0 md:col-span-2">
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-3">
                            ...
                            <input type="text" name="sms_from" id="sms_from" value="{{ old('sms_from', $configuration->sms_from) }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            @error('sms_from')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-span-3">
                            ...
                            <input type="text" name="sms_login" id="sms_login" value="{{ old('sms_login', $configuration->sms_login) }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            @error('sms_login')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-span-6">
                            ...
                            <input type="url" name="sms_url" id="sms_url" value="{{ old('sms_url', $configuration->sms_url) }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="col-span-6">
                            ...
                            <input type="url" name="sms_url_check" id="sms_url_check" value="{{ old('sms_url_check', $configuration->sms_url_check) }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                ...
                <div class="mt-5 md:mt-0 md:col-span-2">
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-3">
                            ...
                            <input type="text" name="schedule_date_format" id="schedule_date_format" value="{{ old('schedule_date_format', $configuration->schedule_date_format) }}" placeholder="Y-m-d H:i:s" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="col-span-3">
                            ...
                            <input type="text" name="schedule_date_value" id="schedule_date_value" value="{{ old('schedule_date_value', $configuration->schedule_date_value) }}" class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
