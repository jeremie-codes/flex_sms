                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div class="flex items-center space-x-2">
                            <a href="{{ route('auth-tokens.show', $token) }}" class="text-blue-600 hover:text-blue-900">Voir</a>
                            <a href="{{ route('auth-tokens.edit', $token) }}" class="text-indigo-600 hover:text-indigo-900">Modifier</a>
